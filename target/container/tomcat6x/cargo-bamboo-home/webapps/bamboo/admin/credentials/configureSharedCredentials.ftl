...
<div id="dropdown-shared-credentials" class="aui-dropdown2 aui-style-default" aria-hidden="false" data-dropdown2-alignment="right">
    <div class="aui-dropdown2-section">
        <ul class="aui-list-truncate">
            [#list action.getCredentialTypes() as item]
                <li><a class="update-credentials" href="[@ww.url action="addSharedCredentials" namespace="admin" createCredentialsKey=item.completeKey returnUrl=currentUrl/]">${item.name!?html}</a></li>
            [/#list]
        </ul>
    </div>
</div>
