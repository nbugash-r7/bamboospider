...
[#macro editElasticInstance mode configuration='']
    ...
    [@s.form action="${action}"
        ...
        [@s.select name='instanceType' list=instanceTypes listKey='name()' listValue='name' key='elastic.instance.type' cssClass="long-field"/]
        ...
        [@ui.bambooSection dependsOn='vpcEnabled' showOn=true]
            [#if subnetMap?has_content]
                [@s.select name='subnets' list=subnetMap listKey='key' listValue='value' key='elastic.instance.vpc.subnet' multiple=true size=subnetMap?size cssClass="long-field" toggle=true/]
            [/#if]
        [/@ui.bambooSection]
