...
[#macro configureBuildStrategy create=false long=false branch=false deployment=false bulk=false]
    ...
    [#if bulk]
        ...
        [/#assign]
        [@ui.bambooSection dependsOn='selectedBuildStrategy' showOn='poll trigger']
