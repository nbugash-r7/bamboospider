                ...
                [#if versionId == 0]
                    ...
                    <div class="radio">
                        <input id="releaseTypeCreateOption"
                            ...
                            [#if !action.hasBranches() && !action.hasDefaultPlanBuildResults()]disabled=disable[/#if]
                        >
                        <label for="releaseTypeCreateOption">[@ww.text name="deployment.version.create"/]</label>
                        [#if !action.hasBranches() && !action.hasDefaultPlanBuildResults()]
                        ...
                        [#else]
                            [@ui.bambooSection dependsOn='releaseTypeOption' showOn='CREATE' cssClass='field-group']
                                ...
                                [@s.textfield
                                    ...
                                    required=true
                                    masterPlanPickerId=action.hasBranches()?string('newReleaseBranchKey', '')
