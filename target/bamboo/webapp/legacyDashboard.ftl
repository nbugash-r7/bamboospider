        ...
        <div id="buildQueueDiv" class="queue">
            ...
            [#if queue?has_content]
                [#list queue as queuedResultKey]
                    [#if fn.hasPlanPermission('READ', queuedResultKey.resultKey.planKey.key) ]
                        <li class="queueItem">
                        ${queuedResultKey_index+1}. <a id="viewBuild:${queuedResultKey.resultKey.planKey}:queue" href="${req.contextPath}/browse/${queuedResultKey.resultKey}">${queuedResultKey.resultKey}</a>
