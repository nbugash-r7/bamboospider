...
<fieldset[#if (parameters.id)?has_content] id="fieldArea_${parameters.id}"[/#if] class="[#if !parameters.skipGroupCssClass!false]group[/#if] [#if parameters.required!false] required[/#if]">
